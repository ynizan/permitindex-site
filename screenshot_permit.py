#!/usr/bin/env python3
"""
Script to capture screenshot of permit pages
"""
...
if __name__ == '__main__':
    # Screenshot the Food Truck permit page
    html_file = 'output/california-food-truck-operating-permit.html'
    output_screenshot = 'output/food-truck-permit-screenshot.png'
